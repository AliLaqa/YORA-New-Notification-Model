...
return response.statusCode;
  ...
  //this function is for customer side, this will be called when order is generated,
  //it send notification to all employees of restaurant
  Future<void> sendNotification(Order? order)
  async {

    //SendMessageApi().sendMessage(doc["DriverToken"],"New booking is available in the driver's pool");

    /*NotificationWidget.showNotification(
      id: 0,
      title: "LiwaCars",
      body: "New booking is available in the driver's pool",
      payload: 'notification_payload',
      sound: 'sound2',
      deviceToken: doc["DriverToken"],
    );*/

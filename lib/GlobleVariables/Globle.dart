...
class Globle {
  ...
  static String countryCode = "03";
  static String testingNumber = "115701702";
  static int numCount = 9;
  static String mapValue = "PK";
  ...
  static String itemImgPath = "https://restaurantstaff.pk/images/Restaurants/" + EndPoints.Resturantid.toString() + "/Items/";
  static String logoPath = "https://restaurantstaff.pk/images/Restaurants/"+ EndPoints.Resturantid.toString() +"/";
  static String bannerimgpath = "https://restaurantstaff.pk/images/Restaurants/"+ EndPoints.Resturantid.toString() +"/Banners/" ;
  static String defaultImg = "https://restaurantstaff.pk/images/Restaurants/"+ EndPoints.Resturantid.toString() +"/NotFound.png";
  //

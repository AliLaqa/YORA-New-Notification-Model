...
class _HomepageState extends State<Homepage>
  ...
  ///Pasting the Google Maps URL instead of Youtube URL.
  String youtubeurl = 'https://maps.app.goo.gl/bRUNdgyUFFauxzCn8';
  ...
  String minRequiredVersion = '1.2.2';
  ...
  ///Get Categories Flunction start
  Future<List<Categry>> getCategories() async {
    ...
    ///Youtube Link is actually Google Maps Link used in the app.
    ///because in backend it's defined as youtube link therefore it's declared as youtube link.
    ...
    return UpgradeAlert(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Test Notifications app", style: TextStyle(fontSize: 14),),
          centerTitle: true,
          elevation: 0,
          actions: <Widget>[
            buildBadge(),

                    ...
                    children: [
                      ...
                      if (order.orderStatus == 'w') ...[
                        ...
                        if(order.orderStatus == 'x')...[
                          ///Card to cancel the order which is in Order Status screen which is in paymentdetail.dart which is displayed after proceed button is pressed.
                          ///Customer Order Cancel Card
                          Card(
                            elevation: 8,
                            child: Container(
                              width: double.infinity,
